      ...
      <div className="container">
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            ...
            <p>
              The all-in-one operating system for creative agencies. Automate
              workflows, delight clients, and scale your team — without the chaos.
            </p>
            ...
            >
              <a
                ...
                aria-label="CreativeFlow on X (Twitter)"
                id="footer-social-x"
                target="_blank"
              ...
              <a
                ...
                className="social-link"
                aria-label="CreativeFlow on LinkedIn"
              ...
              <a
                ...
                className="social-link"
                aria-label="CreativeFlow on GitHub"
        ...
        <div className="footer__bottom">
          <p className="footer__copy">
            © {new Date().getFullYear()} CreativeFlow, Inc. All rights reserved.
          </p>
          <nav
